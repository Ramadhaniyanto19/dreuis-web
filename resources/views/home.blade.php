    ...
    <div class="flex flex-col w-full h-full">
        ...
        <div id="default-carousel" class="relative w-full" data-carousel="slide">
            ...
            <button type="button"
                ...
                data-carousel-prev>
                <span
                    class="inline-flex items-center justify-center w-10 h-10 rounded-full bg-custom-green dark:bg-gray-800/30 group-hover:bg-custom-blue dark:group-hover:bg-gray-800/60 group-focus:ring-4 group-focus:ring-white dark:group-focus:ring-gray-800/70 group-focus:outline-none">
