            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center justify-start rtl:justify-end">
                    ...
                    <a href="/dashboard" class="flex ms-2 md:me-24">
                        ...
                        <span class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">Rs
                            DrEuis</span>
                    </a>
                </div>
            ...
            <ul class="space-y-2 font-medium">
                ...
                <li>
                    <a href="/dashboard-dokter"
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">Daftar Dokter</span>
                    </a>
                </li>
                <li>
                ...
                <li>
                    <a href="/dashboard-riwayat-janji"
                        class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                            aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                            viewBox="0 0 20 18">
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">Riwayat Janji</span>
                    </a>
                </li>
                <li>
                    <a href="/dashboard-carousel"
                        ...
                        <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                            ...
                            viewBox="0 0 20 18">
                            <path
                                d="M18 0H2a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2ZM2 2h6v14H2V2Zm16 14h-6V2h6v14Z" />
                            <path
